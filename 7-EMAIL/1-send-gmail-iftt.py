...
PASSWORD = "project123!"
MAILTO  = "projectjunkieslabs@gmail.com"

msg = MIMEText(' Hello Partcipents How are you. This is the body of the email')
msg['Subject'] = 'Temparature Exceeds' #Mail from RPI 3. This email subject
msg['From'] = USERNAME
msg['To'] = MAILTO
