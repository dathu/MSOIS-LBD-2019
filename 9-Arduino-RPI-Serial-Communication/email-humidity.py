...
msg = MIMEText(' Hello Partcipents How are you Switch on the Air Conditioner. This is the body of the email')
msg['Subject'] = 'Mail from RPI 3. Humidity is Very High  This email subject'
msg['From'] = USERNAME
msg['To'] = MAILTO
