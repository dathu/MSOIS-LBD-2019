...
msg = MIMEText(' Hello Partcipents How are you Switch on the fan. This is the body of the email')
msg['Subject'] = 'Mail from RPI 3. Temparature is too hot This email subject'
msg['From'] = USERNAME
msg['To'] = MAILTO
